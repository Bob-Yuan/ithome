...
from activity.views import PointRewardView, LotteryRewardView, Game2048View, LotteryView, MyLotteryView

app_name = "activity"

urlpatterns = [
    path('redeem/<int:id>', PointRewardView.as_view(), name="point_reward"),
